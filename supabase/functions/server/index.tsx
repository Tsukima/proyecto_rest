...
const DEFAULT_WEEKDAY_MENU = {
  menus: [
    ...
    },
    {
      ...
      sections: [
        { title: "Aperitivo", items: [{ name: "Petisco de bienvenida", allergens: [] }] },
        { title: "Primero", items: [{ name: "Focaccia de aceituna al horno con texturas de tomate y brotes aliñados", allergens: ["Gluten", "Lácteos", "Huevos"] }] },
        { title: "Segundo", items: [{ name: "Orecchiette en salsa de pesto, timbal de verduras salteadas y polvo de oliva negra", allergens: ["Gluten", "Frutos secos"] }] },
        { title: "Postre", items: [{ name: "Semifrío de limón", allergens: ["Lácteos", "Gluten"] }] },
      ],
    },
  ],
  degustation: {
    ...
    sections: [
      ...
      { title: "Del Mar", items: [{ name: "Bonito de Burela \"todo al rojo\"", allergens: ["Pescado", "Moluscos"] }] },
      { title: "De la Tierra", items: [{ name: "Lingote de cordero deshuesado, su demiglace y cromatismos naranjas", allergens: ["Lácteos", "Gluten"] }] },
      { title: "Está de Dulce", items: [{ name: "Mil hojas de Santiago", allergens: ["Lácteos", "Gluten", "Huevos"] }] },
    ],
  },
};
